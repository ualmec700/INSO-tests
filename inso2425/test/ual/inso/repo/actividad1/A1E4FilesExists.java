...
public class A1E4FilesExists extends BaseTC {
	...
	public void setUp() throws Exception {
		...
		vppSourcePathStudent = "/A1E4/vpproject/";
		umlSourcePathStudent = "/A1E4/";
	...
	@Test
	public void FileA1E4vppDoesNotExists() {
		fileName = "A1E4.vpp";
	...
	@Test
	public void FileA1E4umlDoesNotExists() {
		fileName = "A1E4.uml";
	...
	//@Test
	public void FileA1E4umlProfileDoesNotExists() {
		fileName = "A1E4.profile.uml";
		Path p = Paths.get(umlSourcePath + fileName);
		assertTrue("El archivo " + umlSourcePathStudent + fileName + " no existe en el respositorio del estudiante.",
				p.toFile().exists());
	}
