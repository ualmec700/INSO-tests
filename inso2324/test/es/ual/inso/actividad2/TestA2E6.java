...
public class TestA2E6 {

	private String testpackage = "actividad2ejercicio6";
	private int testncl = 6;
	private int testncla = 1;
	private int testngener = 2;
	private int testnassoc = 7;
	private int testnattr = 7;
	private int testnop = 16;
	private int testnenum = 1;

	private static String modelName = "A2E6.uml";
	private static String path = "../../main/A2E6/";
