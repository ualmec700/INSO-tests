...
public class TestA3E3 {

  private static String modelName = "A3E3.uml";
	private static String path = "../../main/A3E3/";

  private String testpackage = "actividad3ejercicio3";

  private static ResourceSet resSet;
  private static String packageName;

  private static Behavior actualizarCartas;
    ...
    for (PackageableElement pe : model.getPackagedElements()) {
      ...
      if (pe instanceof org.eclipse.uml2.uml.Collaboration) {
        ...
        for (Behavior ob : colab.getOwnedBehaviors()) {
          ...
          if (dseName.equalsIgnoreCase("actualizarCartas")) {
            actualizarCartas = ob;
            loadActualizarCartas(ob);
  ...
  private static void loadActualizarCartas(org.eclipse.uml2.uml.Behavior dse) {
...
//        }
  ...
  public void testDiagramasDeSecuencia() {
    ...
    assertNotEquals("No existe el diagrama 'actualizarCartas'.", actualizarCartas, null);

  }

  @Test
  public void testLifeLinesActualizarCartas() {
    if (actualizarCartas != null) {
      boolean ll1 = lld1.contains("Restaurante");
      boolean ll2 = lld1.contains("Carta");
      boolean ll3 = lld1.contains("Tapa");
      assertTrue("La clase Restaurante no está bien representada en 'actualizarCartas'.", ll1);
      assertTrue("La clase Carta no está bien representada en 'actualizarCartas'.", ll2);
      assertTrue("La clase Tapa no está bien representada en 'actualizarCartas'.", ll3);
    }
  }

  @Test
  public void testLoop1ActualizarCartas() {
    if (actualizarCartas != null) {
      boolean ll1 = coveredLoopD1.contains("Restaurante");
      boolean ll2 = coveredLoopD1.contains("Carta");
      boolean ll3 = coveredLoopD1.contains("Tapa");
      assertTrue("El bucle principal no abarca correctamente la clase Restaurante en 'actualizarCartas'.", ll1);
      assertTrue("El bucle principal no abarca correctamente la clase Carta en 'actualizarCartas'.", ll2);
      assertTrue("El bucle principal no abarca correctamente la clase Tapa en 'actualizarCartas'.", ll3);
    }
  }
