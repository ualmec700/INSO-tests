...
public class TestA3E1 {

  private static String modelName = "A3E1.uml";
	private static String path = "../../main/A3E1/";

  private String testpackage = "actividad3ejercicio1";

  private static ResourceSet resSet;
  private static String packageName;

  private static Behavior jugarPartida;
    ...
    for (PackageableElement pe : model.getPackagedElements()) {
      ...
      if (pe instanceof org.eclipse.uml2.uml.Collaboration) {
        ...
        for (Behavior ob : colab.getOwnedBehaviors()) {
          ...
          if (dseName.equalsIgnoreCase("jugarPartida")) {
            jugarPartida = ob;
            loadJugarPartida(ob);
  ...
  private static void loadJugarPartida(org.eclipse.uml2.uml.Behavior dse) {
...
//        }
  ...
  public void testDiagramasDeSecuencia() {
    ...
    assertNotEquals("No existe el diagrama 'jugarPartida'.", jugarPartida, null);

  }

  @Test
  public void testLifeLinesJugarPartida() {
    if (jugarPartida != null) {
      boolean ll1 = lld1.contains("Avanzado");
      boolean ll2 = lld1.contains("Partida");
      assertTrue("La clase Avanzado no está bien representada en 'jugarPartida'.", ll1);
      assertTrue("La clase Partida no está bien representada en 'jugarPartida'.", ll2);
    }
  }

  @Test
  public void testLoop1JugarPartida() {
    if (jugarPartida != null) {
      boolean ll1 = coveredLoopD1.contains("Avanzado");
      boolean ll2 = coveredLoopD1.contains("Partida");
      assertTrue("El bucle principal no abarca correctamente la clase Avanzado en 'jugarPartida'.", ll1);
      assertTrue("El bucle principal no abarca correctamente la clase Partida en 'jugarPartida'.", ll2);
    }
  }
